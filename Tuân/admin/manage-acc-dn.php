...
?>
            ...
            <div class="warp">
                <div class="table_title">
                    ...
                    <a href="#" class="table_choice active">Disney</a> /
                    <a href="manage-acc-net.php" class="table_choice none">Netflix</a>
                </div>
                <div class="table_form">
                    <form action="account-add.php" method="POST">
                        ...
                        <button class="btn" type="submit" name="btn_add-dn">Thêm</button>
                    </form>
                </div>
                <div class="table">
                    ...
                    <div class="table_row <?php echo checkColorUsed($row) ?>">
                        ...
                        <div class="row row-edit">
                            ...
                            <a href="account-delete.php?id_dn=<?php echo $row['id'] ?>" class="row-edit-icon red">
                ...
                <div class="pagination">
                    ...
                    for($i = 1; $i <= $total_page; $i++) {
                        if($i == $current_page) {
                            ...
                            echo "<a href='manage-acc-dn.php?page=". $i ."'>" . $i . "</a>";
                        }
                    }
                    ?>
                </div>
                ...
                <div class="modal-warp">
                    ...
                    <div class="modal-body">
                        <form action="account-edit.php?id" method="POST">
                            ...
                            <div class="body-row">
                                <button class="btn" name="btn_edit-dn">Cập nhật</button>
                            </div>
                        </form>
                    </div>
                </div>
