        ...
        <div id="content">
            <div class="grid wide-1000 table__acc-container">
                <div class="table__acc-title">
                    ...
                    <a href="manage-account-dn.php" class="table__acc-name-sv color-blue bold-6 active">Disney+</a>
                    <span class="table__acc-name-divive color-orange">/</span>
                    <a href="manage-account-net.php" class="table__acc-name-sv color-red bold-6">Netflix</a>
                </div>
                <div class="table__acc-input">
                    <form action="account-add.php" method="POST" class="flex-between">
                        ...
                        <button type="submit" name="btn_add-dn" class="btn-add bold-6">Add</button>
                    </form>
                </div>
                <div class="table__acc">
                    ...
                    <?php 
                    $sql = "SELECT * FROM account_disney LIMIT $start, $limit";
                    ...
                    <div class="table__acc-list">
                        ...
                        <div class="row-table_acc table__acc-edit">
                            ...
                            <a href="account-delete.php?id_dn=<?php echo $row['id'] ?>">
            ...
            <div class="pagination">
                ...
                for($i = 1; $i <= $total_page; $i++) {
                    if($i == $current_page) {
                        ...
                        echo "<a class='num-page' href='manage-account-dn.php?page=". $i ."'>" . $i . "</a>";
                    }
                }    
                ?>
            </div>
            ...
            <div class="modaEA-container js-modaEA-container">
                ...
                <div class="modaEA__body bold-5">
                    <form action="account-edit.php" method="POST">
                        ...
                        <button name="btn_edit-dn" class="EA-confirm bold-6">
                            Cập nhật
                        </button>
                    </form>
                </div>
